...
HISTORY:
  ...
  15-Feb-2014 AT  Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.18 to TK5.2.19 for ECS drop
  25-Jun-2018 AT Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.19 to TK5.2.20 for ECS drop
END_FILE_PROLOG:
*****************************************************************/
...
#define PGSd_TOOLKIT_MAJOR_VERSION       "TK5.2.20"
#ifdef PGS_DAAC
...
#ifdef PGS_DAAC
#    define PGSd_TOOLKIT_VERSION_STRING "DAAC  TK5.2.20"
#else
#    define PGSd_TOOLKIT_VERSION_STRING  "SCF  TK5.2.20"
#endif
