...
#define  PGSd_DEM_NOT_ACCESSED  -1
  ...
  /* Define unaccessable subgrid number. This subgrid number will work in PGS_DEM_AccessFile()
     only when command is PGSd_DEM_CLOSE */

#define  PGSd_DEM_SUBGRID_NULL -1000000
