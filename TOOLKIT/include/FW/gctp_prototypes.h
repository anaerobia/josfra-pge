...
HISTORY:
	...
	27-June-00 AT  added function prototypes for CEA projection
        24-Jan-14  AT  Modified lamazforinit and lamazinvinit to support
                       ellipsoid earth for EASE GRID 2.0
...
int lamazforint(double r_maj, double r_min, double center_long, double center_lat, 
                double false_east, double false_north);
int lamazinvint(double r_maj, double r_min, double center_long, double center_lat, 
                double false_east, double false_north);
...
int sinforint(double r_maj, double r_min, double center_long, double false_east, 
                double false_north);
int sininvint(double r_maj, double r_min, double center_long, double false_east, 
                double false_north);
