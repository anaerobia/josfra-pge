/*********************************************************
PGS_DEM_ReplaceFillPointsInt8.c--
...
This Function only replaces fill points for layers with data types of INT8 
...
{
    /*pointer to switch dataRegionIn to int8 pntr. */
    int8 *dataRegion;
	...
	for (i = 0; i < totalNumPixels; i++)
	{
	    if (dataRegion[i] == (int8)(subsetInfo -> fillvalue))
	    {
		numFillPoints ++;
