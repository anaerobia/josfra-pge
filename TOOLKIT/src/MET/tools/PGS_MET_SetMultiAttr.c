...
DESCRIPTION:
	Enables the user to set the multiple values of metadata parameters 
...
DESCRIPTION:
	...
	are automatically set (if data location is defined as MCF or PCF) and some 
        are set by the user using PGS_MET_SetAttr() or PGS_MET_SetMultiAttr().
...
PGSt_SMF_status
PGS_MET_SetMultiAttr(			     /* Sets multi metadata attribute values
					      */
             PGSt_MET_handle  	mdHandle,    /* metadata group within MCF containing 
					      * the parameter */
					      ...
					      */
{
	...
	char *			errInserts[PGSd_MET_MAX_ERR_INSERTS] = {NULL}; 
							 ...
							 * error messages
							 */
	char *			funcName = "PGS_MET_SetMultiAttr";
