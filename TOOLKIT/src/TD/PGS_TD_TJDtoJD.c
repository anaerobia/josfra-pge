...
DESCRIPTION:
   This file contains the function PGS_TD_TJDtoJD().
...
HISTORY:
   06-Oct-1995  GTSK  Initial version
...
TITLE:
   Convert Truncated Julian Date To Julian Date
...
PGS_TD_TJDtoJD(
    ...
    PGSt_double    julianDate[2])
{
    /* The Julian date is just the truncated Julian date plus 2440000.5. */
    ...
    julianDate[0] = truncatedJulianDate[0] + 2440000.5;
    julianDate[1] = truncatedJulianDate[1];
