...
DESCRIPTION:
   This file contains the function PGS_TD_JDtoMJD().
...
RETURNS:
   modified Julian date (address of modifiedJulianDate).
...
PGS_TD_JDtoMJD(
    ...
    PGSt_double    modifiedJulianDate[2])
{
    /* The modified Julian date is just the Julian date minus 2400000.5. */
    ...
    modifiedJulianDate[0] = julianDate[0] - 2400000.5;
    modifiedJulianDate[1] = julianDate[1];
