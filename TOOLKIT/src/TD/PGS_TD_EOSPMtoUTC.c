...
DESCRIPTION:
   This file contains the function PGS_TD_EOSPMtoUTC().
   This function converts EOS PM spacecraft clock time in CCSDS unsegmented Time
...
TITLE:
   Convert EOS PM Clock Time to UTC Time
...
INPUTS:
   ...
   ----      -----------                  -----       ---           ---
   scTime    EOS PM clock time in CCSDS        ** see NOTES below **
...
#define FUNCTION_NAME "PGS_TD_EOSPMtoUTC()"

PGSt_SMF_status
PGS_TD_EOSPMtoUTC(              /* converts EOS PM s/c time to ASCII UTC */
    unsigned char *scTime,      /* EOS PM s/c time in CCSDS unseg. time code */
