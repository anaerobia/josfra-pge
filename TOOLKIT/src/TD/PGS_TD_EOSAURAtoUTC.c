...
FILENAME:   
   PGS_TD_EOSAURAtoUTC.c

DESCRIPTION:
   This file contains the function PGS_TD_EOSAURAtoUTC().
   This function converts EOS AURA spacecraft clock time in CCSDS unsegmented Time
...
TITLE:
   Convert EOS AURA Clock Time to UTC Time
...
INPUTS:
   ...
   ----      -----------                  -----       ---           ---
   scTime    EOS AURA clock time in CCSDS        ** see NOTES below **
...
#define FUNCTION_NAME "PGS_TD_EOSAURAtoUTC()"

PGSt_SMF_status
PGS_TD_EOSAURAtoUTC(              /* converts EOS AURA s/c time to ASCII UTC */
    unsigned char *scTime,      /* EOS AURA s/c time in CCSDS unseg. time code */
