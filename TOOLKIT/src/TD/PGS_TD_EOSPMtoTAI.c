...
DESCRIPTION:
   This file contains the function PGS_TD_EOSPMtoTAI().
   This function converts EOS PM spacecraft clock time in CCSDS Unsegmented
...
TITLE:
   Convert EOS PM Clock Time to TAI Time
...
INPUTS:
   NAME      DESCRIPTION
   ----      -----------
   scTime    EOS PM clock time in CCSDS unsegmented time code format (CUC).
...
#define FUNCTION_NAME "PGS_TD_EOSPMtoTAI()"

PGSt_SMF_status
PGS_TD_EOSPMtoTAI(                /* converts EOS PM s/c time to TAI */
    PGSt_scTime   scTime[8],      /* EOS PM s/c time in CUC */
