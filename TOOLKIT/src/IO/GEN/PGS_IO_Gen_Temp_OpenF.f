...
!     14-Jul-1995 DPH Removed invalid environment variables references 
...
!                     mandatory for direct access (minumum value = 1)
!                     ignored otherwise
!                    
!
! OUTPUTS:      
...
!     are PGS_S_SUCCESS and PGSIO_W_GEN_DURATION_NOMOD.  All
!     other values force a jump to exception handling.
!     -------------------------------------------------------
