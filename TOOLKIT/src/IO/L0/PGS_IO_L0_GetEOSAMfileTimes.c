...
FILENAME:
   PGS_IO_L0_GetEOSAMfileTimes.c

DESCRIPTION:
   This file contains the function PGS_IO_L0_GetEOSAMfileTimes().  This function
    ...
    unsigned long*       size)                /* size of construction record */
{
    ...
    returnStatus = PGS_TD_EOSAMtoTAI(construction_record+offset,
				     &start_stop[0][0]);
