...
FILENAME:
   PGS_IO_L0_GetEOSAURAfileTimes.c

DESCRIPTION:
   This file contains the function PGS_IO_L0_GetEOSAURAfileTimes().  This function
    ...
    unsigned long*       size)                /* size of construction record */
{
    ...
    returnStatus = PGS_TD_EOSAURAGIIStoTAI(construction_record+offset,
				     &start_stop[0][0]);
