/*****************************************************************************
  ...
  26 October 1996, Alward N. Siyyid 	Changed the value for MAX_RIGHT_MARGIN
                                        from 132 to 317 to allow for long 
                                        words in a string
  17 November 2008, Abe Taaheri         Added ODLFormatStringlen function
                                        for just getting number of characters 
                                        that ODLFormatString will be adding to
                                        the stmt string.	
...
/*****************************************************************************
  ...
  ODLFormatStringlen:  get length of an ODL string value to be formated 
                       for output.
  ...
  Output:  The number of characters put in he string (when calling  
           ODLFormatString) is returned as the function value.
                                                       
 ****************************************************************************/


int ODLFormatStringlen (VALUE_DATA *item, int *column, 
                     int left_margin, int right_margin, int format_flag, 
                     int is_pointer)
...
#define indentf1(X) for (i=0 ; i < X ; i++) len++
