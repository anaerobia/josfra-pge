...
!
!FILENAME:
!  PGS_EPH_EphAtt_unInterpolateF.f
!
!DESCRIPTION:
...
!   condition this function just calls pgs_eph_unInterpolate2 the underlying
!   fortran function(which declares two temporary arrays for proper fortran
!   binding). The function pgs_eph_unInterpolate2 calls the underlying C 
...
!      include 'PGS_MEM_7.f'
!
!      integer function pgs_eph_ephatt_unInterpolate
...
!                     code A format
!		     
!   numValuesEphAtt   As output this is 
...
!
!      returnstatus =  pgs_eph_ephatt_uninterpephAtt
...
!******************************************************************************
     ...
     > 				          attitquat)
      ...
      integer          pgs_eph_ephatt_uninterpolate2
     ...
     >                               'PGS_EPH_EphAtt_unInterpolate()') 
         pgs_eph_ephatt_uninterpolate = pgseph_e_bad_array_size
         return
      ...
      pgs_eph_ephatt_uninterpolate = pgs_eph_ephatt_uninterpolate2
     >                                   (spacecrafttag,asciiutcstart,
     >                                    asciiutcstop,orbflag,
     >                                    attflag,qualityflags,
     >                                    tmpvalues,
...
! error will be returned.
      ...
      integer function pgs_eph_ephatt_uninterpolate2
     >                                   (spacecrafttag,asciiutcstart,
     >                                    asciiutcstop,orbflag,
     >                                    attflag,qualityflags,
     >                                    numvalueseph,
     ...
     > 				          attitquat)
      ...
      integer          pgs_smf_setstaticmsg
      integer          pgs_eph_ephatt_uninterpolatec
      ...
      pgs_eph_ephatt_uninterpolate2 = pgs_eph_ephatt_uninterpolatec
     >                              (spacecrafttag,asciiutcstart,
     >                               asciiutcstop,orbflag,
     >                               attflag,qualityflags,
     >                               numvalueseph,
     ...
     >'actual eph numvalues larger than BLOCK_SIZE in',
     >                               'pgs_eph_ephatt_uninterpolate2()') 
         pgs_eph_ephatt_uninterpolate2 = pgseph_e_bad_array_size
         return
      else 
