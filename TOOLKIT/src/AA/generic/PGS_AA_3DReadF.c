...
HISTORY:
	...
	03-October-94   GJB     Create F version
	16-Feb-95       GJB     Clean and add frees
...
FORTRAN:
	 ...
	 integer function pgs_aa_3dread( iparms, nparms, xStart, yStart, 
	 zStart, xDim, yDim, zDim, fileId, version, operation, results )
	      character*99 iparms(*)
	      integer      nParms,
	      integer      xStart,
  	      integer      yStart,
...
DESCRIPTION:
 ...
 PGS_AA_Map, PGS_AA_GetSupp, PGS_AA_FF_Setup and PGS_AA_3DReadGrid.  
...
C:
	...
	shortint results[2][20][50]
        char iparms[][100] = {"OlsonWorldEcosystems1.3a"};
	longint	nParms = 1;
        longint	xStart = 4;
        longint	yStart = 7;
        longint	zStart = 2;
	...
	PGSt_SMF_status = PGS_AA_3DRead (iparms, 			
	nParms, xStart, yStart, zStart, xDim, yDim, zDim, fileId, version, 1, 
        results);
...
FORTRAN:
	...
	character*99 parms(4)
        ...
        call pgs_aa_3dread( iparms, nparms, xStart, yStart, 
	 zStart, xDim, yDim, zDim, fileId, version, operation, results )
	      ...
	      void *results)
{
    ...
    val = PGS_AA_3DReadGridF(parms, nParms, xStart, yStart, zStart, 
			    xDim, yDim, zDim, parmBuffer, 
    ...
    PGS_SMF_SetStaticMsg (PGS_S_SUCCESS,"PGS_AA_3DRead");
