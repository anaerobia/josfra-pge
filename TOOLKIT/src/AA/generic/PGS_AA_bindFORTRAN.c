...
HISTORY:
  	07-June-95 	ANS 	Initial version
        03-March-2000   AT      made the contents the same as the one in DCW
                                directory, so that when overwitten to library
                                we will have all binders.
...
FCALLSCFUN10(INT,PGS_AA_2DReadF,PGS_AA_2DREAD,pgs_aa_2dread,STRINGV,INT,INT,INT,INT,INT,INT,INT,INT,PVOID)

#define pgs_aa_2dgeo_STRV_A1 NUM_ELEMS(4)
FCALLSCFUN9(INT,PGS_AA_2DgeoF,PGS_AA_2DGEO,pgs_aa_2dgeo,STRINGV,INT,DOUBLEV,DOUBLEV,INT,INT,INT,INT,PVOID)

#define pgs_aa_3dgeo_STRV_A1 NUM_ELEMS(4)
FCALLSCFUN10(INT,PGS_AA_3DgeoF,PGS_AA_3DGEO,pgs_aa_3dgeo,STRINGV,INT,DOUBLEV,DOUBLEV,INTV,INT,INT,INT,INT,PVOID)

#define pgs_aa_3dread_STRV_A1 NUM_ELEMS(4)
FCALLSCFUN12(INT,PGS_AA_3DReadF,PGS_AA_3DREAD,pgs_aa_3dread,STRINGV,INT,INT,INT,INT,INT,INT,INT,INT,INT,INT,PVOID)

#define pgs_aa_dem_STRV_A1 NUM_ELEMS(4)
FCALLSCFUN9(INT,PGS_AA_demF,PGS_AA_DEM,pgs_aa_dem,STRINGV,INT,DOUBLEV,DOUBLEV,PINT,INT,INT,INT,PVOID)

FCALLSCFUN3(INT,PGS_AA_PeV_string,PGS_AA_PEV_STRING, pgs_aa_pev_string, INT, PSTRING, PSTRING)

FCALLSCFUN3(INT,PGS_AA_PeV_real,PGS_AA_PEV_REAL, pgs_aa_pev_real, INT, PSTRING,PDOUBLE)

FCALLSCFUN3(INT,PGS_AA_PeV_integer,PGS_AA_PEV_integer, pgs_aa_pev_integer, INT, PSTRING,PINT)
