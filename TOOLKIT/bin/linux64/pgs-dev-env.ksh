...
# SDP installation done on Wed Jul 27 15:29:56 PDT 2022 
# 
 
PGSHOME=/home/jsg/SIPS/eta2/TOOLKIT	# set the toolkit home directory
...
LD_LIBRARY_PATH="/opt/packages/szip-2.1.1/lib:/opt/packages/hdf5-1.8.19/lib:$LD_LIBRARY_PATH"
else
LD_LIBRARY_PATH="/opt/packages/szip-2.1.1/lib:/opt/packages/hdf5-1.8.19/lib"
fi
...
case "$BRAND" in
    ...
    cray)
	CC=cc 			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000" 		# default C flags (optimize, ansi)
	C_CFH="-DCRAYFortran"   # C/cfortran.h called from FORTRAN
	CFHFLAGS="$CFLAGS $C_CFH" # CFLAGS + C_CFH
	F77=cf77		# FORTRAN compiler
	F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
    ...
    dec)
	CC=cc 			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -std"	# default C flags (optimize, ansi)
    ...
    hp)
	CC=cc 			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -Ae" 	# default C flags (optimize, ansi)
    ...
    ibm)
	CC=cc 			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -qlanglvl=ansi" # default C flags (optimize, ansi)
	C_CFH="" 		# C w/ cfortran.h callable from FORTRAN
	CFHFLAGS="$CFLAGS $C_CFH" # CFLAGS + C_CFH
	...
	if [ "`echo $pgs_f90_comp | grep pgf90`" != "" ] || [ "$F77" = "pgf77" ] ; then
		...
		F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -fno-second-underscore"
    ...
    macintosh)
        CC=gcc                          # C compiler
        CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DMACINTOSH"        # default C flags (optimize, ansi)
        C_CFH="-Df2cFortran"            # C w/ cfortran.h callable from FORTRAN
        CFHFLAGS="$CFLAGS $C_CFH"       # CFLAGS + C_CFH
        F77=g77
        F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -fno-second-underscore" # common FORTRAN flags
    ...
    macintel | macintel32 | macintel64)
        ...
        CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DMACINTEL"         # default C flags (optimize, ansi)
        C_CFH="-Df2cFortran"            # C w/ cfortran.h callable from FORTRAN
        CFHFLAGS="$CFLAGS $C_CFH"       # CFLAGS + C_CFH
    ...
    cygwin)
        CC=gcc                          # C compiler
        CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DCYGWIN"            # default C flags (optimize, ansi)
        C_CFH="-Df2cFortran"            # C w/ cfortran.h callable from FORTRAN
        CFHFLAGS="$CFLAGS $C_CFH"       # CFLAGS + C_CFH
        F77=g77
        F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -fno-second-underscore" # common FORTRAN flags
    ...
    sco)
	CC=cc 			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -posix"	# default C flags (optimize, ansi)
	C_CFH="-Df2cFortran"	# C w/ cfortran.h callable from FORTRAN
	CFHFLAGS="$CFLAGS $C_CFH" # CFLAGS + C_CFH
	...
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -xansi -D_POSIX_SOURCE"	# default C flags (optimize, ansi)
	C_CFH=""	 	# C w/ cfortran.h callable from FORTRAN
	CFHFLAGS="$CFLAGS $C_CFH" # CFLAGS + C_CFH
	F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
        F77_CFH=""              # FORTRAN callable from C w/ cfortran.h
    ...
    sun4)
	CC=acc			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -Xa" 	# default C flags (optimize, ansi)
    ...
    *)
	CC=cc			# C compiler
	CFLAGS="-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000" 		# default C flags (optimize)
	C_CFH=""	# C w/ cfortran.h callable from FORTRAN
	CFHFLAGS="$CFLAGS $C_CFH" # CFLAGS + C_CFH
	F77=f77 		# FORTRAN compiler
	F77FLAGS="-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
...
if [ "$pgs_absoft_flag" = "1" ] ; then		# using ABSOFT f77
        F77="$fc_path/f77 "
        F77FLAGS="-W -f -s -N15 -N26 -O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000"
fi
...
HDFHOME=/opt/packages/hdf4-4.2.15	# set HDF home directory
HDF5HOME=/opt/packages/hdf5-1.8.19       # set HDF5 home directory
...
ZLIBHOME=/opt/packages/zlib-1.2.11  # set ZLIB home directory
...
JPEGHOME=/opt/packages/jpeg-9b  # set JPEG home directory
...
SZIPHOME=/opt/packages/szip-2.1.1  # set SZIP home directory
...
HDFEOS_HOME=/home/jsg/SIPS/eta2/TOOLKIT/hdfeos	# set HDF-EOS home directory
...
HDFEOS5_HOME=/opt/packages/hdfeos5.2.0       # set HDF-EOS5 home directory
