...
# SDP installation done on Wed Jul 27 15:30:06 PDT 2022 
# 
 
setenv PGSHOME /home/jsg/SIPS/eta2/TOOLKIT       # set the toolkit home directory
...
setenv LD_LIBRARY_PATH "/opt/packages/szip-2.1.1/lib:/opt/packages/hdf5-1.8.19/lib:$LD_LIBRARY_PATH"
else
setenv LD_LIBRARY_PATH "/opt/packages/szip-2.1.1/lib:/opt/packages/hdf5-1.8.19/lib"
endif
...
switch ($BRAND)
	...
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000" 		# default C flags (optimize, ansi)
	...
	setenv F77FLAGS "-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
    ...
    case dec:
	setenv CC cc 			# C compiler
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -std"		# default C flags (optimize, ansi)
    ...
    case hp:
	setenv CC cc 			# C compiler
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -Ae" 		# default C flags (optimize, ansi)
    ...
    case ibm:
	setenv CC cc 			# C compiler
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -qlanglvl=ansi" # default C flags (optimize, ansi)
	setenv C_CFH "" 		# C w/ cfortran.h callable from FORTRAN
	setenv CFHFLAGS "$CFLAGS $C_CFH" # CFLAGS + C_CFH
	...
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -ansi"	# default C flags (optimize, ansi)
	...
	if ( "`echo $pgs_f90_comp | grep pgf90`" != "" || "$F77" == "pgf77" ) then
		...
		setenv F77FLAGS "-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -fno-second-underscore"
    ...
    case macintosh:
        setenv CC gcc                   # C compiler
        setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DMACINTOSH" # default C flags (optimize, ansi)
        setenv C_CFH "-Df2cFortran"     # C w/ cfortran.h callable from FORTRAN
        setenv CFHFLAGS "$CFLAGS $C_CFH"# CFLAGS + C_CFH
        setenv F77 "g77"                # FORTRAN compiler - default
        setenv F77FLAGS "-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -fno-second-underscore" # common FORTRAN flags  
    ...
    case macintel64:
        ...
        setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DMACINTEL"  # default C flags (optimize, ansi)
        setenv C_CFH "-Df2cFortran"     # C w/ cfortran.h callable from FORTRAN
        setenv CFHFLAGS "$CFLAGS $C_CFH"# CFLAGS + C_CFH
    ...
    case cygwin:
        ...
        setenv CC gcc                   # C compiler
        setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DCYGWIN"     # default C flags (optimize, ansi)
        setenv C_CFH "-Df2cFortran"     # C w/ cfortran.h callable from FORTRAN
        setenv CFHFLAGS "$CFLAGS $C_CFH"  # CFLAGS + C_CFH

        setenv CPPFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -DCYGWIN"   # default C ++ flags (optimize)
    ...
    case sco:
	setenv CC cc 			# C compiler
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -posix"	# default C flags (optimize, ansi)
	setenv C_CFH "-Df2cFortran"	# C w/ cfortran.h callable from FORTRAN
	setenv CFHFLAGS "$CFLAGS $C_CFH" # CFLAGS + C_CFH
	...
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -xansi -D_POSIX_SOURCE"	# default C flags (optimize, ansi)
	setenv C_CFH ""	 		# C w/ cfortran.h callable from FORTRAN
	setenv CFHFLAGS "$CFLAGS $C_CFH" # CFLAGS + C_CFH
	setenv F77FLAGS "-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
        setenv F77_CFH ""               # FORTRAN callable from C w/ cfortran.h
	...
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -Xa" 		# default C flags (optimize, ansi)
    ...
    default:
	setenv CC cc			# C compiler
	setenv CFLAGS "-O2 -DH5_USE_16_API -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000" 		# default C flags (optimize)
	setenv C_CFH ""	        	# C w/ cfortran.h callable from FORTRAN
	setenv CFHFLAGS "$CFLAGS $C_CFH" # CFLAGS + C_CFH
	setenv F77 f77 			# FORTRAN compiler
	setenv F77FLAGS "-O2 -DH5_USE_16_API -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000" 		# common FORTRAN flags
...
setenv HDFHOME /opt/packages/hdf4-4.2.15	# set HDF home directory
setenv HDF5HOME /opt/packages/hdf5-1.8.19        # set HDF5 home directory
...
setenv ZLIBHOME /opt/packages/zlib-1.2.11  # set ZLIB home directory
...
setenv JPEGHOME /opt/packages/jpeg-9b  # set JPEG home directory
...
setenv SZIPHOME /opt/packages/szip-2.1.1  # set SZIP home directory
#
...
setenv HDFEOS_HOME /home/jsg/SIPS/eta2/TOOLKIT/hdfeos	# set HDF-EOS home directory
...
setenv HDFEOS5_HOME /opt/packages/hdfeos5.2.0        # set HDF-EOS5 home directory
