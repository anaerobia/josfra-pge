...
# SDP installation done on Wed Jul 27 15:30:01 PDT 2022 
# 
...
# install option:  -pgshome /opt/packages/sdptk5.2.20v1.01/TOOLKIT -log sdptk.log -zlibhome /opt/packages/zlib-1.2.11 -jpeghome /opt/packages/jpeg-9b -sziphome /opt/packages/szip-2.1.1 -hdfhome /opt/packages/hdf4-4.2.15 -hdf5home /opt/packages/hdf5-1.8.19 -hdfeos5_home /opt/packages/hdfeos5.2.0 -hdfeos_home /home/jsg/SIPS/eta2/TOOLKIT/hdfeos -netcdfhome /opt/packages/netcdf-c-4.8.1 -fc_path /usr/bin/gfortran -cc_path /usr/bin/gcc -cpp_path /usr/bin/cpp -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -m64 -fPIC -pthread -s -m128bit-long-double -mcmodel=large -mlarge-data-threshold=90000000 -ff2c -m64 -fPIC -pthread -s -m128bit-long-double -fdec-structure -fdec -mcmodel=large -mlarge-data-threshold=90000000 -c_rlib
